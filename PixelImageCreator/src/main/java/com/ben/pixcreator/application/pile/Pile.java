 ...
 * 
 * If a max size is set > 0, the pile pops out the lower indexed item after add operations.
 * 
 * @author bmo
 *
 */
public class Pile<T> implements Serializable
{
      ...
      /**
       * adds a new item to this itemList on "top" of the others. The index assigned to this new item is the current size of the list, no check is done on the existing indexes.
       * 
       * @param item
      ...
      /**
       * @param item
       * @return the index of the item or -1 if the item is not present in this itemList
       */
      ...
      /**
       * removes the item associated with the index in this item list. \nReturns false if the index was either not found or the removal was unsuccessful.
       * 
       * @param idx
       ...
       * Returns false if the item was either not found or the removal was unsuccessful.
       * 
       * @param item
       * @return true if the item was successfully removed from this item list
       */
       ...
       * 
       * @param item
       * @return the new index of the item after the move or -1 if the item is not present in this item list
       */
      ...
      /**
       * moves the item one slot down in this item list or nothing if the item has the index 0.
       * 
       * @param item
       * @return the new index of the item after the move or -1 if the item is not present in this item list or has the index 0
       */
       ...
       * @param item
       * @param newitem
       * @return the index of the new item after the move or -1 if the item is not present in this item list
       */
      ...
      /**
       * * inserts a new item in this item list right under another given item.<br/>
       * Indexes are modified accordingly.
       * 
       * @param item
       * @param newitem
