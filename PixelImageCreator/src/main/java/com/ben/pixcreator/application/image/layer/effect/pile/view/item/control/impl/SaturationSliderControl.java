...
public class SaturationSliderControl extends StackPane implements IEffectPileViewItemControl {

	private Slider		slider;
	ParamValue<Double>	params;
	private double		save	= 0;

	public SaturationSliderControl(Effect fx) {

		params = (ParamValue<Double>) fx.getParams().get(Param.SATURATION);
