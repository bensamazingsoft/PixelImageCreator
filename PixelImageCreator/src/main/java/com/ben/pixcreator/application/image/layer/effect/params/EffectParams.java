...
public class EffectParams implements Serializable {
	...
	*/
	...
	public static enum Param {
		OPACITY, XSIZE, YSIZE, KEEPRATIO, HUE, SATURATION, BRIGHTNESS, COLOR, FONTFAMILY, FONTSIZE, FONTWEIGHT, FONTPOSTURE, TEXT, TXTALIGN, TXTBASELINE, SAMPLEFACTOR, LUMAKEY, LUMAKEYINVERT;
	}
